...
@section('body')
    <div class="wrapper dashboard">
        <div class="sub-wrapper">
            ...
            <div class="container dashboard">
                <form action="/administrasi/daftarlaporan" method="POST" class="form dashboard" enctype="multipart/form-data">
                    @csrf
    ...
    <script>
        ...
        title.addEventListener('change', function() {
            fetch('/administrasi/dashboard/checkSlug?nama=' + title.value)
