...
@section('body')
    <div class="wrapper dashboard">
        <div class="sub-wrapper">
            ...
            <h4 class="main-title daftar">Laporan</h4>
            <div class="container table">
                <div class="card-lapor">
                    ...
                    <div class="content">
                        <h4>Tanggal</h4>
                        <p>:</p>
                        <p>{{ $lapor->created_at->setTimezone('Asia/Jakarta')->format('m-d-Y H:i') }}</p>
                    </div>
                    <div class="content">
                        <h4>Alamat</h4>
                        <p>:</p>
                ...
                <div class="container dua">
                    <div class="validation">
                        <button class="btn print" onclick="window.print()">Print Content</button>
                    ...
                    <div class="content-comment">
                        <form method="POST" class="comment" action="/administrasi/daftarlaporan/{{ $lapor->slug }}">
                            @csrf
                            ...
                            @foreach ($lapor->comments()->latest()->paginate(4) as $comment)
                                <div class="content-comments">
                                    <div class="account-comment">
                                        <h4 class="name">{{ $comment->user->role }} <br> {{ $comment->user->username }}
                                        </h4>
    ...
    <script>
        ...
        checkbox.addEventListener('change', function() {
            ...
            fetch('/administrasi/daftarlaporan/{{ $lapor->slug }}/validasi?newValue=' + newValue)
