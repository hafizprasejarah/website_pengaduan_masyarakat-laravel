                ...
                <div class="card-daftar @if ($lapor->validasi == 1) validate @endif">
                    ...
                    <div class="group pict">
                        ...
                        <div class="group keterangan">
                            ...
                            <textarea type="text" readonly class="input-laporan hasil" placeholder="Laporan" name="{{ $lapor->slug }}" equired autocomplete="off">
                                {{ $lapor->lapor }}
                        </textarea>
                        </div>
                        <div class="group alamat">
                            <p class="title-daftar">Alamat</p>
                            <textarea type="text" readonly class="input-laporan hasil alamat"  name="{{ $lapor->slug.'alamat' }}" placeholder="Laporan" required autocomplete="off">
                                {{ $lapor->alamat }}
                        </textarea>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <a href="/administrasi/daftarlaporan/{{ $lapor->slug }}"><button class="btn-single"><i
                                        class="fa-solid fa-chevron-right"></i></button></a>


                            <form action="/administrasi/daftarlaporan/delete/{{ $lapor->slug }}" method="post">
                                @csrf
                                <button class="btn-delete" onclick="return confirm('are you sure')"><i
