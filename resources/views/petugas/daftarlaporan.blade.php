                ...
                @foreach ($lapors as $lapor)
                    <div class="card-daftar @if ($lapor->validasi == 1) validate @endif">
                        ...
                        <div class="group keterangan">
                            ...
                            <textarea type="text" readonly class="input-laporan hasil" name="{{ $lapor->slug }}" placeholder="Laporan" required autocomplete="off">
                                {{ $lapor->lapor }}
                        </textarea>
                        </div>
                        ...
                        <div class="group">
                            ...
                            <a href="/petugas/daftarlaporan/{{ $lapor->slug }}"><button class="btn-single"><i
                                        class="fa-solid fa-chevron-right"></i></button></a>


                            <form action="/petugas/daftarlaporan/delete/{{ $lapor->slug }}" method="post">
                                @csrf
